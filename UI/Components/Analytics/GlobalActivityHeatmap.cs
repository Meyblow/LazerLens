                            ...
                            new Container
                            {
                                ...
                                Child = new FillFlowContainer
                                {
                                    ...
                                    Children = new Drawable[]
                                    {
                                        ...
                                        createLegendBox(Color4Extensions.FromHex("#4c2882")),
                                        createLegendBox(Color4Extensions.FromHex("#7038b8")),
                                        createLegendBox(Color4Extensions.FromHex("#9b51e0")),
                                        createLegendBox(Color4Extensions.FromHex("#bb86fc")),
                                        new OsuSpriteText
                                        {
                                            Anchor = Anchor.CentreLeft,
                                            Origin = Anchor.CentreLeft,
