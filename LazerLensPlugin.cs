...
namespace LazerLens
{
    public class LazerLensPlugin : OsuCcPluginBase, IOsuCcIconProvider
    {
        ...
        private void onScoreImported(ScoreInfo score, bool passed)
        {
            EnsureHooked();

            LazerLensPatch.DebugLog($"LazerLensPlugin: onScoreImported received score: Title={score.BeatmapInfo?.Metadata?.Title}, Passed={passed}");
